...
//                                      }: {
//     vacanciesId: number[] | null, // Allow null for safety
...
//
//     // Clean vacanciesId to remove undefined/null values
//     // const uniqueVacancyIds = vacanciesId
//     //     ? Array.from(new Set(vacanciesId.filter(id => !isNaN(id) && id !== null && id !== undefined)))
//     //     : [];
//     //
//     // console.log('Cleaned vacancyIds:', uniqueVacancyIds); // Should log [1, 2]
//
//     // const handleSearch = () => {
//     //     if (uniqueVacancyIds.length === 0) {
//     //         toast.error('Нет вакансий для поиска');
//     //         return;
//     //     }
//     //
//     //     setIsSearching(true);
//     //     router.post(
//     //         route('recommended.user'),
//     //         { vacancyIds: uniqueVacancyIds },
//     //         {
//     //             onSuccess: () => {
//     //                 setIsSearching(false);
//     //                 toast.success('Рекомендации успешно получены!');
//     //                 router.reload({ only: ['recommended', 'vacanciesId'] });
//     //             },
//     //             onError: (errors) => {
//     //                 setIsSearching(false);
//     //                 toast.error('Ошибка при поиске пользователей: ' + JSON.stringify(errors));
//     //             },
//     //         }
//     //     );
//     // };
